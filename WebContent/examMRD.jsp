...
String sql="select ANS from QUES where QID=2";
int marks=0;
...
//int x3=x2+marks;
String sql1="update STUD set MARKS1="+marks+" where ID="+ab+"";
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 forms-right-icons">
                    <div class="section-heading">
                     ...
                     <!--    <h2>your total marks :<span> </span></h2><br>
                       --> <h3>Now If you want to <span> give Operating System exam</span><a href="examOS.jsp?rd=1"> click here</a></h3><br>
                        <p class="subheading">
                        </p>
                    </div>
<%  		
