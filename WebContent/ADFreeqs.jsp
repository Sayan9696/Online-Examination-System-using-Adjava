...
try{
	...
	<br><center><h5><span><h2><b><%=rs.getString(2)%></b></h2></span></h5></center> 
...
<h5><p style="color:black;">Qs:<%out.print(++c); %>)<%=ns.getString(3)%></p></h5>

<h5><span>
<p>(a)<%=ns.getString(4)%>    <br>      (b)<%=ns.getString(5)%></p>

</span></h5>


<h3><p style="color:black;">Right answer:<span><%=ns.getString(6)%></span></p></h3>
<br></div></div></div></div>
<%} %></section></div></div>
