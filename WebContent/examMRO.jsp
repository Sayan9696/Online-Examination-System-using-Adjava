...
String x1=(String)f.getAttribute("m1");*/
//out.print(n);

String sql="select ANS from QUES where QID=3";
int marks=0;
...
//int x3=x2+marks;
String sql1="update STUD set MARKS2="+marks+" where ID="+ab+"";

Statement st=cn.createStatement();

st.executeUpdate(sql1);

String sql3="select * from STUD where ID="+ab+"";
Statement st1=cn.createStatement();
ResultSet zs=st.executeQuery(sql3);
int total=0;String cgf;
if(zs.next()){
		
	total=zs.getInt(6)+zs.getInt(7)+zs.getInt(8);
	if(total>10)
	{
		cgf="pass";
	}
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 forms-right-icons">
                    <div class="section-heading">
                     ...
                     <h2>your total marks :<span><%out.print(total);%> </span></h2><br>
                     <h2>So you are:<span><%out.print(" "+cgf);%> </span></h2><br>
                     
                        <h3>Now If you want to <span> go home</span><a href="index.html"> click here</a></h3><br>
                        <p class="subheading">
                        </p>
                    </div>
<%  }		
