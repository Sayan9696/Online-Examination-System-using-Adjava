     ...
     <section id="top_banner">
        <div class="banner">
            <div class="inner text-center">
                <h2> New Notice <span> Successfully Stored.....</span> 
            </div>
        </div>
    </section>
...
try{
	...
	if(pw.equals("")||cname.equals(""))
	{out.print("please fill the form");
		RequestDispatcher rd=request.getRequestDispatcher("notiST.html");
		...
		int Qd=0;
		PreparedStatement p=cn.prepareStatement("select max(ID) from NOTICE");
