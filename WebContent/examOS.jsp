...
try{
	...
	String sql="select * from QUES where QID=3";
...
int v=0;
	...
	{ 
		...
		p++;
%>	<form method="get" id="form" action="examMRO.jsp">
...
<h6>Qs:<%out.print(++c); %>)<%=ns.getString(3)%></h6>
 	...
 	<h7>
<font color="black"><input type="radio"   name="rh<%out.print(p);%>" value="<%out.print(row[ms]);%>" >  1)<%out.print(row[ms]);%>  
