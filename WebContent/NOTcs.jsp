...
try{
	...
	while(rs.next()){
		...
		out.print("<div class=col-md-6 col-sm-12 forms-right-icons><p class=subheading><h3><b><span>"+c+"   "+rs.getString(2)+"       "+"</span> </b>     for open <b><a href=notCSA.jsp?rd="+rs.getString(2)+">click here</a></b></h3></p></div>");/*
