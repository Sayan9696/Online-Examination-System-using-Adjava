...
try{
	...
	int c=0;
	String sql="select * from NOTICE where SUB=?";
	...
	if(rs.next()){
		...
		out.print("<br><div class=section-heading><h3><center><b><span>   "+rs.getString(2)+"</span> </b> </center>  </h3></div></div><br></div>");
		
		out.print("<p class=subheading><h4><center>"   +rs.getString(3)+"       "+"   </h4></center></p>");/*
