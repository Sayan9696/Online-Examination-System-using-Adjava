...
try{
	...
	<br><center><h3><span>Object Oriented Programming</span></h3></center> 
...
int v=0;
	...
	String[] row = new String[2];	int qz=0;%>
...
%>	
<li>
                    <a data-toggle="tab" href="#<%out.print(++qz);%>"><%out.print(qz);%></a> </li>
            ...
            <!-- Top content -->
             ...
             <% }%>
         <%  p=0;   ns=ps.executeQuery();
         %> </ul><div class="container"></div></div><div class="tab-content">	<section id="login-reg"><form method="get" id="form" action="examMR.jsp">
         <%
    while(ns.next())
	{p++; %>
                    ...
                    <div class="tab-pane fade <%if(p==1){out.print("in active");} %>"  id="<%out.print(++c);%>"><div align="left">
<font size="20">Qs:<%out.print(c); %>)<%=ns.getString(3)%></font>
